  ...
  data () {
    return {
      ...
      indicatorList: [
        ...
        { isActive: false, id: '#About', title: 'Tentang Nopal', linkId: '1' },
        { isActive: false, id: '#Projects', title: 'Aktivitas', linkId: '2' },
        { isActive: false, id: '#Somedia', title: 'Tempat PKL', linkId: '3' },
        {
          isActive: false,
          id: '#ContactManager',
          title: 'SUDIN PPAPP JakSel',
          linkId: '4'
        },
        { isActive: false, id: '#MemoryGame', title: 'School', linkId: '5' },
        {
          isActive: false,
          id: '#TumblrcClone',
          title: 'My Hobbies',
